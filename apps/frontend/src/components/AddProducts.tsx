        ...
        <div className="w-full lg:w-1/3 m-1">
          <form className="w-full bg-white shadow-md p-6">
            <div className="flex flex-wrap -mx-3 mb-6">
              ...
              <div className="w-full md:w-full px-3 mb-6">
                <button className="appearance-none block w-full bg-indigo-500 text-gray-100 font-bold border border-gray-200 rounded-lg py-3 px-3 leading-tight hover:bg-indigo-600 focus:outline-none focus:bg-white focus:border-gray-500">
                  Add Product
                </button>
              </div>
              ...
              <div className="w-full px-3 mb-8">
                <label
                  className="mx-auto cursor-pointer flex w-full max-w-lg flex-col items-center justify-center rounded-xl border-2 border-dashed border-indigo-600 bg-white p-6 text-center"
