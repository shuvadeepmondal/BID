  ...
  return (
    <>
      ...
      <div className="max-w-6xl mx-auto h-[80vh] flex flex-col justify-center items-center">
        ...
        <p className="text-gray-700 text-sm lg:text-lg mt-3">
          Shop and trade your products with your buddies
        </p>
        <Link to="/market">
          <button
            className="mt-3 tracking-wide text-center font-semibold bg-indigo-500 text-gray-100 w-full px-5 py-2 rounded-lg hover:bg-indigo-700 transition-all duration-300 ease-in-out flex items-center justify-center focus:shadow-outline focus:outline-none"
            type="button"
          >
            Explore
          </button>
